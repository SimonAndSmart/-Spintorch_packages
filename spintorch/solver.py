...
class MMSolver(nn.Module):
    ...
    def __init__(self, geometry, dt: float, sources=[], probes=[],damping_width=10): # changes here! -Sinan
        ...
        # added below _sinan
        self.mask = None # to mask the unnecessary probes for a training batch
        self.all_labels = []
        self.probe_coordinate={'p_center':[],'Train':None,'Test':None}# probe center, training method, testing(showing) method
...
#         return outputs
    ...
    def measure_probes(self, m, Msat, outputs): 
        ...
        for i, probe in enumerate(self.probes):
            # Apply the mask to skip probes with zero weight
